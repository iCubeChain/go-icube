...
func (b *ContractBackend) CallContract(ctx context.Context, msg icube.CallMsg, blockNum *big.Int) ([]byte, error) {
...
// call with the specified data as the input. The pending flag requests execution
// against the pending block, not the stable head of the chain.
func (b *ContractBackend) PendingCallContract(ctx context.Context, msg icube.CallMsg) ([]byte, error) {
	out, err := b.bcapi.Call(ctx, toCallArgs(msg), rpc.PendingBlockNumber)
	return out, err
}

func toCallArgs(msg icube.CallMsg) ethapi.CallArgs {
...
func (b *ContractBackend) EstimateGas(ctx context.Context, msg icube.CallMsg) (*big.Int, error) {
