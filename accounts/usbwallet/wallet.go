...
import (
	...
	icube "github.com/icube/go-icube"
...
type wallet struct {
	...
	deriveChain    icube.ChainStateReader // Blockchain state reader to discover used account with
...
func (w *wallet) SelfDerive(base accounts.DerivationPath, chain icube.ChainStateReader) {
	w.stateLock.Lock()
	defer w.stateLock.Unlock()
