...
import (
	...
	"github.com/icube/go-icube/common/math"
...
func (b *SimulatedBackend) CallContract(ctx context.Context, call icube.CallMsg, blockNumber *big.Int) ([]byte, error) {
	b.mu.Lock()
	defer b.mu.Unlock()
...
func (b *SimulatedBackend) PendingCallContract(ctx context.Context, call icube.CallMsg) ([]byte, error) {
	b.mu.Lock()
	defer b.mu.Unlock()
...
func (b *SimulatedBackend) EstimateGas(ctx context.Context, call icube.CallMsg) (*big.Int, error) {
	b.mu.Lock()
	defer b.mu.Unlock()
...
func (b *SimulatedBackend) callContract(ctx context.Context, call icube.CallMsg, block *types.Block, statedb *state.StateDB) ([]byte, *big.Int, bool, error) {
