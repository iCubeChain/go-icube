...
type ContractCaller interface {
	...
	// input.
	CallContract(ctx context.Context, call icube.CallMsg, blockNumber *big.Int) ([]byte, error)
}
...
type PendingContractCaller interface {
	...
	PendingCallContract(ctx context.Context, call icube.CallMsg) ([]byte, error)
}
...
type ContractTransactor interface {
	...
	EstimateGas(ctx context.Context, call icube.CallMsg) (usedGas *big.Int, err error)
