...
//
// Detailed usage document and tutorial available on the go-icube Wiki page:
// https://github.com/icube/go-icube/wiki/Native-DApps:-Go-bindings-to-Ethereum-contracts
package bind
