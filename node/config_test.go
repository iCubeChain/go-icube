...
func TestIPCPathResolution(t *testing.T) {
	var tests = []struct {
		...
		{"", "", false, ""},
		{"data", "", false, ""},
		{"", "icube.ipc", false, filepath.Join(os.TempDir(), "icube.ipc")},
		{"data", "icube.ipc", false, "data/icube.ipc"},
		{"data", "./icube.ipc", false, "./icube.ipc"},
		{"data", "/icube.ipc", false, "/icube.ipc"},
		{"", "", true, ``},
		{"data", "", true, ``},
		{"", "icube.ipc", true, `\\.\pipe\icube.ipc`},
		{"data", "icube.ipc", true, `\\.\pipe\icube.ipc`},
		{"data", `\\.\pipe\icube.ipc`, true, `\\.\pipe\icube.ipc`},
	}
