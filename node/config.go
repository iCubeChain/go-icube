...
import (
	...
	"github.com/icube/go-icube/accounts/usbwallet"
...
func DefaultIPCEndpoint(clientIdentifier string) string {
	...
	/*
		if clientIdentifier == "geth" {
			clientIdentifier = "icube"
		}

		log.Info(fmt.Sprintf("------------IPC endpoint clientIdentifier: %s", clientIdentifier))
	*/
...
func makeAccountManager(conf *Config) (*accounts.Manager, string, error) {
	...
	default:
		// There is no datadir.
		keydir, err = ioutil.TempDir("", "go-icube-keystore")
		ephemeral = keydir
	}
	if err != nil {
		return nil, "", err
