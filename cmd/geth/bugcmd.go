...
import (
	...
	"github.com/icube/go-icube/cmd/internal/browser"
...
const issueUrl = "https://github.com/icube/go-icube/issues/new"

// reportBug reports a bug by opening a new URL to the go-icube GH issue
