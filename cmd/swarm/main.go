...
import (
	...
	"github.com/icube/go-icube/cmd/utils"
	"github.com/icube/go-icube/common"
	"github.com/icube/go-icube/console"
	"github.com/icube/go-icube/contracts/ens"
	"github.com/icube/go-icube/crypto"
	"github.com/icube/go-icube/ethclient"
	"github.com/icube/go-icube/internal/debug"
	...
	"github.com/icube/go-icube/swarm"
	bzzapi "github.com/icube/go-icube/swarm/api"
...
var (
	...
	SwarmNetworkIdFlag = cli.IntFlag{
		Name:  "bzznetworkid",
		Usage: "Network identifier (integer, default 120=swarm testnet)",
	}
...
func init() {
	...
	defaultNodeConfig.P2P.ListenAddr = ":30829"
	defaultNodeConfig.IPCPath = "bzzd.ipc"
	// Set flag defaults for --help display.
	utils.ListenPortFlag.Value = 30829
}
...
func init() {
	...
	app.Copyright = "Copyright 2013-2016 The go-icube Authors"
...
Export a local chunk database as a tar archive (use - to send to stdout).
    ...
    swarm db export ~/.icube/swarm/bzz-KEY/chunks chunks.tar

The export may be quite large, consider piping the output through the Unix
pv(1) tool to get a progress bar:

    swarm db export ~/.icube/swarm/bzz-KEY/chunks - | pv > chunks.tar
`,
				},
				{
					Action:    dbImport,
...
Import chunks from a tar archive into a local chunk database (use - to read from stdin).
    ...
    swarm db import ~/.icube/swarm/bzz-KEY/chunks chunks.tar

The import may be quite large, consider piping the input through the Unix
pv(1) tool to get a progress bar:

    pv chunks.tar | swarm db import ~/.icube/swarm/bzz-KEY/chunks -
`,
				},
				{
					Action:    dbClean,
