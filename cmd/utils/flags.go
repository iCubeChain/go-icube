...
// Package utils contains internal helper functions for go-icube commands.
package utils
...
import (
	...
	"github.com/icube/go-icube/accounts"
	"github.com/icube/go-icube/accounts/keystore"
	"github.com/icube/go-icube/common"
	"github.com/icube/go-icube/consensus"
	"github.com/icube/go-icube/consensus/clique"
	"github.com/icube/go-icube/consensus/ethash"
	"github.com/icube/go-icube/core"
	"github.com/icube/go-icube/core/state"
	"github.com/icube/go-icube/core/vm"
	"github.com/icube/go-icube/crypto"
	"github.com/icube/go-icube/eth"
	"github.com/icube/go-icube/eth/downloader"
	"github.com/icube/go-icube/eth/gasprice"
	"github.com/icube/go-icube/ethdb"
	"github.com/icube/go-icube/ethstats"
	"github.com/icube/go-icube/les"
	"github.com/icube/go-icube/log"
	"github.com/icube/go-icube/metrics"
	"github.com/icube/go-icube/node"
	"github.com/icube/go-icube/p2p"
	"github.com/icube/go-icube/p2p/discover"
	"github.com/icube/go-icube/p2p/discv5"
	"github.com/icube/go-icube/p2p/nat"
	"github.com/icube/go-icube/p2p/netutil"
	"github.com/icube/go-icube/params"
	whisper "github.com/icube/go-icube/whisper/whisperv5"
...
var (
	...
	NetworkIdFlag = cli.Uint64Flag{
		Name:  "networkid",
		Usage: "Network identifier (integer, 110=mainnet, 120=testnet)",
		Value: eth.DefaultConfig.NetworkId,
	}
	TestnetFlag = cli.BoolFlag{
		Name:  "testnet",
		Usage: "Icube test network: pre-configured proof-of-work test network",
	}
	/*
...
func SetNodeConfig(ctx *cli.Context, cfg *node.Config) {
	...
	case ctx.GlobalBool(DevModeFlag.Name):
		cfg.DataDir = filepath.Join(os.TempDir(), "icube_dev_mode")
	case ctx.GlobalBool(TestnetFlag.Name):
