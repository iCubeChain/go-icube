...
import (
	...
	"github.com/icube/go-icube/crypto/sha3"
...
// See https://github.com/icube/EIPs/issues/176 for the test format specification.
...
func (tx *stTransaction) toMessage(ps stPostState) (core.Message, error) {
	...
	// Value, Data hex encoding is messy: https://github.com/icube/tests/issues/203
	value := new(big.Int)
	if valueHex != "0x" {
